package com.couragegang.bff.metrics;
...
/** Исходящий HTTP: latency + outcome/status для золотых сигналов интеграций. */
@Singleton
public final class OutboundHttpMetrics {

    private static final String METRIC = "bff.integration.http";
    ...
    private void stop(
        ...
        var timer =
                Timer.builder(METRIC)
                        .description("Outbound HTTP to downstream BC")
